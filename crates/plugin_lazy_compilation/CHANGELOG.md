...
## [0.0.16](https://github.com/Roxannej/farm/compare/farmfe_plugin_lazy_compilation-v0.0.15...farmfe_plugin_lazy_compilation-v0.0.16) - 2025-08-18

### Other

- test hmr host check ([#2190](https://github.com/Roxannej/farm/pull/2190))
# Changelog
All notable changes to this project will be documented in this file.

...
## [2.0.1](https://github.com/Roxannej/farm/compare/farmfe_plugin_script-v2.0.0...farmfe_plugin_script-v2.0.1) - 2025-09-04

### Other

- updated the following local packages: farmfe_core, farmfe_testing_helpers, farmfe_toolkit, farmfe_swc_transformer_import_glob
# Changelog
All notable changes to this project will be documented in this file.

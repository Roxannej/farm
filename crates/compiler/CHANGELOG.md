...
## [2.0.1](https://github.com/Roxannej/farm/compare/farmfe_compiler-v2.0.0...farmfe_compiler-v2.0.1) - 2025-09-04

### Fixed

- windows hmr syntax error ([#2240](https://github.com/Roxannej/farm/pull/2240))
# Changelog
All notable changes to this project will be documented in this file.
